...
class db_sign_in(wx.Dialog):
    ...
    def __init__(self, parent):
        ...
        self.header = wx.StaticText(self, wx.ID_ANY, u"Enter Connection Details ", wx.DefaultPosition, wx.DefaultSize,
                                    0 | wx.BORDER_RAISED)
        self.header.Wrap(-1)
        ...
        self.message1 = wx.TextCtrl(self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize,
                                    wx.TE_MULTILINE)
...
class select_file(wx.Dialog):
    ...
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=u"Select a CSV file...", pos=wx.DefaultPosition,
        ...
        self.file_selected = wx.FilePickerCtrl(self, wx.ID_ANY, wx.EmptyString, u"Select a file", u"*.*",
                                               wx.DefaultPosition, wx.DefaultSize,
                                               wx.FLP_CHANGE_DIR | wx.FLP_DEFAULT_STYLE | wx.FLP_SMALL)
        ...
        bSizer4.Add(self.b_ok, 0, wx.ALL, 5)
        
        self.b_cancel = wx.Button(self, wx.ID_ANY, u"Cancel", wx.DefaultPosition, wx.DefaultSize, 0)
        bSizer4.Add(self.b_cancel, 0, wx.ALL, 5)
